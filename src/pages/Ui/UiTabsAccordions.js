      ...
      <div className="page-content">
        ...
        <Row>
          ...
          <Col xl={6}>
            <Card>
              <CardBody>
                <h4 className="card-title">Accordion Flush</h4>
                ...
                <Accordion flush open={open} toggle={toggles}>
                  <AccordionItem>
                    <AccordionHeader targetId="1">Accordion Item #1</AccordionHeader>
                    <AccordionBody accordionId="1">Placeholder content for this accordion, which is intended to demonstrate the <code>.accordion-flush</code> class. This is the first item's accordion body.</AccordionBody>
                  </AccordionItem>
                  <AccordionItem>
                    <AccordionHeader targetId="2">Accordion Item #2</AccordionHeader>
                    <AccordionBody accordionId="2">Placeholder content for this accordion, which is intended to demonstrate the <code>.accordion-flush</code> class. This is the second item's accordion body. Let's imagine this being filled with some actual content.</AccordionBody>
                  </AccordionItem>
                  <AccordionItem>
                    <AccordionHeader targetId="3">Accordion Item #3</AccordionHeader>
                    <AccordionBody accordionId="3">Placeholder content for this accordion, which is intended to demonstrate the <code>.accordion-flush</code> class. This is the third item's accordion body. Nothing more exciting happening here in terms of content, but just filling up the space to make it look, at least at first glance, a bit more representative of how this would look in a real-world application.</AccordionBody>
                  </AccordionItem>
                </Accordion>
              </CardBody>
            </Card>
          ...
          <Col xl={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">Omit the <code>data-bs-parent</code> attribute on each <code>.accordion-collapse</code> to make accordion items stay open when another item is opened.</p>
                <UncontrolledAccordion defaultOpen="1" className="accordion" stayOpen>
                  <AccordionItem>
